        ...
        create or replace transient table ramiz_bozai_sandbox_dev.dbt_rbozai.fct_order_items  as
        (

with order_item as (
    
    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.order_items

),
part_supplier as (
    
    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.part_suppliers
