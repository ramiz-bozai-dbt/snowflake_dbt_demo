        ...
        create or replace transient table ramiz_bozai_sandbox_dev.dbt_rbozai.order_items  as
        (with orders as (
    
    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_tpch_orders

),

line_item as (

    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_tpch_line_items
