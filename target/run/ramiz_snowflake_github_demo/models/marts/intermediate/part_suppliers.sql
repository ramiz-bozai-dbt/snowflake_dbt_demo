        ...
        create or replace transient table ramiz_bozai_sandbox_dev.dbt_rbozai.part_suppliers  as
        (with part as (
...
supplier as (
    ...
    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_tpch_suppliers

),

part_supplier as (

    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_tpch_part_suppliers
