  ...
  create or replace  view ramiz_bozai_sandbox_dev.dbt_rbozai.int_model_test_summary
...
relationships as (
    select * from ramiz_bozai_sandbox_dev.dbt_rbozai.int_direct_relationships
),
