  ...
  create or replace  view ramiz_bozai_sandbox_dev.dbt_rbozai.int_direct_relationships
...
all_graph_resources as (
    select
        ...
        materialized,
        source_name 
    from ramiz_bozai_sandbox_dev.dbt_rbozai.int_all_graph_resources
),
...
direct_model_relationships as (
    ...
    from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_node_relationships
),
...
direct_exposure_relationships as (
    select  
        ...
        direct_parent_id,
        is_primary_relationship
    from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_exposure_relationships
),
...
direct_metrics_relationships as (
    select  
        ...
        direct_parent_id,
        is_primary_relationship
    from ramiz_bozai_sandbox_dev.dbt_rbozai.stg_metric_relationships
),
